    ...
    return (
      <>
        <button
          ...
          className="fixed top-4 right-4 z-50 flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-405 hover:text-slate-600 hover:bg-slate-200/50 transition bg-white/40 backdrop-blur-sm border border-slate-350/20 shadow-sm cursor-pointer select-none print:hidden"
          title="Cerrar sesión"
        >
